...
train_files = glob.glob('/search_labs/users/beidchen/workspace/aloi/aloi_lsh/data/amazon_shuf_train')
test_files = glob.glob('/search_labs/users/beidchen/workspace/aloi/aloi_lsh/data/amazon_shuf_test')
