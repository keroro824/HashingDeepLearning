...
train_files = glob.glob('/efs/users/beidchen/workspace/aloi/aloi_lsh/data/wikiLSHTC_shuf_train.txt')
test_files = glob.glob('/efs/users/beidchen/workspace/aloi/aloi_lsh/data/wikiLSHTC_shuf_test.txt')
weights = np.load('/efs/users/beidchen/workspace/SUBLIME/HashingDeepLearning/bgd_new/log_paper/wiki/weight.npz')
...
with open("/efs/users/beidchen/workspace/SUBLIME/HashingDeepLearning/bgd_new/log_paper/wiki/log_wiki_sample_e-4_tf", 'a') as out:
    for i in range(2*n_steps,4*n_steps):
        if i%1000==0:
