...
import glob
train_files = glob.glob('/efs/users/beidchen/workspace/aloi/aloi_lsh/data/amazonCat_shuf_train.txt')
test_files = glob.glob('/efs/users/beidchen/workspace/aloi/aloi_lsh/data/amazonCat_shuf_test.txt')
