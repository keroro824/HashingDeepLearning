...
# files = ["log_q2bn_2_100_4_0.05", "log_q2bn_2_100_8_0.05", "log_q2bn_2_100_16_0.05", "log_q2bn_2_100_4_0.005", "log_q2bn_2_100_8_0.005", "log_q2bn_2_100_16_0.005"]

# files = ["log_q2bn_4_100_5_0.05", "log_q2bn_4_100_10_0.05", "log_q2bn_4_100_20_0.05", "log_q2bn_4_100_5_0.005", "log_q2bn_4_100_10_0.005", "log_q2bn_4_100_20_0.005"]

# files = ["log_q2bn_4_4000_5_0.05", "log_q2bn_4_4000_10_0.05", "log_q2bn_4_4000_20_0.05", "log_q2bn_4_4000_5_0.005", "log_q2bn_4_4000_10_0.005", "log_q2bn_4_4000_20_0.005"]
# legends = ["5, 0.05", "10, 0.05", "20, 0.05", "5, 0.005", "10, 0.005", "20, 0.005"]


files = ["log_0.005"]
legends = ["4, 0.05", "8, 0.05", "16, 0.05", "4, 0.005", "8, 0.005", "16, 0.005"]
i=0
for file in files:
	with open("logs/"+file) as cp:
		# reader = csv.reader(cp, delimiter=' ')
		reader = csv.reader((x.replace('\0', '') for x in cp), delimiter=" ")
		y = []
