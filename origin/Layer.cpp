...
Layer::Layer(int noOfNodes, int previousLayerNumOfNodes, int layerID, NodeType type, int batchsize)
{
	_layerID = layerID;
	...
	{
		_Nodes[i] = new Node(previousLayerNumOfNodes, i, _layerID, type, batchsize);
	}	
