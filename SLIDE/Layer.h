...
public:
  ...
  std::vector<Node> &getAllNodes();
	...
	int queryActiveNodeandComputeActivations(Vec2d<int> &activenodesperlayer, Vec2d<float> &activeValuesperlayer, std::vector<int> &inlenght, int layerID, int inputID,  const std::vector<int> &label, float Sparsity, int iter, bool train);
