...
public:
	...
	int predictClass(int ** inputIndices, float ** inputValues, const std::vector<int> &length, const Vec2d<int> &labels, const std::vector<int> &labelsize);
	int ProcessInput(int** inputIndices, float** inputValues, const std::vector<int> &lengths, const Vec2d<int> &label, const std::vector<int> &labelsize, int iter, bool rehash, bool rebuild);
