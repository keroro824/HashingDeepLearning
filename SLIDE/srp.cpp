...
int *SparseRandomProjection::getHash(const float *vector, int length) {
...
int *SparseRandomProjection::getHashSparse(const int* indices, const float *values, size_t length) {
    int *hashes = new int[_numhashes];
