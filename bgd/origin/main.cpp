...
//
//
//    Network* _mynet = new Network(sizesOfLayers, layersTypes, 3, 1000);
...
int main()
{
    ...
    for (int e=0; e< EPOCH; e++) {
        float accumlogss = 0;
        std::string str;
        FILE *fimage = fopen("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/sgd/tf/MNIST_data/train-images-idx3-ubyte", "rb");
        FILE *flabel = fopen("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/sgd/tf/MNIST_data/train-labels-idx1-ubyte", "rb");
        assert(fimage);
        assert(flabel);
        ...
        FILE *fimaget = fopen("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/sgd/tf/MNIST_data/t10k-images-idx3-ubyte", "rb");
        FILE *flabelt = fopen("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/sgd/tf/MNIST_data/t10k-labels-idx1-ubyte", "rb");
        assert(fimaget);
        assert(flabelt);
...
//    for (int e=0; e< EPOCH; e++) {
//        float accumlogss = 0;
//        ifstream ifs ("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/tf/test.csv");
//        char dummy;
//        vector <int> myValues;
...
//        }
//
//        ifstream lab ("/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/tf/label.csv");
//        char dummyl;
//        vector <int> myValuesl;
//        for (int i = 0; i < totRecords; ++i){
//            for (int j = 0; j < 1; ++j){
//                lab >> x;
//                myValuesl.push_back(x);
//            }
//        }
//
//        for (size_t b = 0; b < numBatches; b++) {
...
//                sizes[k] = col;
//                records[k] = new int[col];
//                values[k] = new float[col];
//                labels[k] = myValuesl[k];
//                cout << labels[k]<< endl;
//
//                for (int i = 0; i < col; i++) {
//                    records[k][i] = i;
//                }
//                for (int i = 0; i < col; i++) {
//                    values[k][i] = myValues[col * k + i];
//                    cout << values[k][i] << endl;
//                }
//            }
//
//
...
////		string testname = "/Users/beidchen/Documents/work/SUBLIME/HashingDeepLearning/bgd/preproc_tst_1";
//        std::ifstream file("/search_labs/users/beidchen/workspace/SUBLIME/HashingDeepLearning/bgd/q2bn/preproc_tr_0");
//        string testname = "/search_labs/users/beidchen/workspace/SUBLIME/HashingDeepLearning/bgd/q2bn/preproc_tst_0";
//
//        assert(file);
//        float accumlogss = 0;
//        std::string str;
...
//                evaluate(testname, 10, BATCHSIZE*10, _mynet);
//            }
//
//        }
//        std::cout << "Finished Epoch" << e << " Loss= " << accumlogss << endl;
